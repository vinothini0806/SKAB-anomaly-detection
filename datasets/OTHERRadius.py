...
def get_files(sample_length, root, InputType, task,test=False):
    ...
    paths = glob.glob("data/OTHER/*.csv")
...
class OTHERRadius(object):
    ...
    def data_preprare(self, test=False):
        if len(os.path.basename(self.data_dir).split('.')) == 2:
            ...
            with open(os.path.normpath(os.path.join('C:\\Users\\situser\\Desktop\\Vinothini\\SUTD\\PHMGNNBenchmark\\data\\OTHER', "OTHERRadius.pkl")), 'wb') as fo:
