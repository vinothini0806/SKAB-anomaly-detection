...
def get_files(sample_length, root, InputType, task,test=False):
    ...
    paths = glob.glob("data/VALVE2/*.csv")
...
class VALVE2Radius(object):
    ...
    def data_preprare(self, test=False):
        if len(os.path.basename(self.data_dir).split('.')) == 2:
            ...
            with open(os.path.normpath(os.path.join('C:\\Users\\situser\\Desktop\\Vinothini\\SUTD\\PHMGNNBenchmark\\data\\VALVE2', "VALVE2Radius.pkl")), 'wb') as fo:
